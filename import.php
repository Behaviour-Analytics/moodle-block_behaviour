...
class import_form extends moodleform {
        ...
        if (isset($imported[$key]->modType) && isset($imported[$key]->modName) &&
            ...
            */
            ...
            for ($i = 0; $i < count($imported[0]); $i++) {
                ...
                $modkey = strtolower($imported[0][$i][4]);
                if ($modkey == 'external tool') {
                    $modkey = 'lti';
                } else if ($modkey == 'assignment') {
                    $modkey = 'assign';
                } else if ($modkey == 'database') {
                    $modkey = 'data';
                } else if ($modkey == 'file') {
                    $modkey = 'resource';
                }
    ...
    private function get_unwanted_users() {
        ...
        $participants = user_get_participants($COURSE->id, 0, 0, 5, 0, 0, []);
