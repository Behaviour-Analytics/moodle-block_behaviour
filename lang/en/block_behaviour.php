...
$string['delclusterdesc'] = 'Deletes all clustering, manual clustering, cluster membership, and centroid comment data for this course.';
$string['delgraph'] = 'Delete graphing data';
$string['delgraphdesc'] = 'Deletes all graph configuration data for this course.';
